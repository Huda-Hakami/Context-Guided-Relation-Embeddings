...
def eval_SemEval(Pair_Embeddings,flag):
	...
	Main_Relation_names={'1':'CLASS-INCLUSION','2':'PART-WHOLE','3':'SIMILAR','4':'CONTRAST','5':'ATTRIBUTE',\
	'6':'NON-ATTRIBUTE','7':'CASE RELATIONS','8':'CAUSE-PURPOSE','9':'SPACE-TIME','10':'REFERENCE'}
	...
	for Q in S.data:
		if Q['filename'] in Relation_Set:
			Acc_dic.setdefault(Q['filename'],0.0)
			Corr_dic.setdefault(Q['filename'],0.0)
			c+=1
			scores = []
			...
			# print (Q['filename'],ACC)
			CORR= S.get_correlation(score_fname, Q["filename"])
			Acc_dic[Q['filename']]=ACC
			Corr_dic[Q['filename']]=CORR
			total_accuracy+=ACC
